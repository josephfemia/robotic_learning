<template>
  <section class="lecture" id="l10" ref="rootEl">
    ...
    <p>The LLM proposes; affordances dispose ("affordance" — robotics-speak for what the current scene physically lets you do; here, each skill's estimated success probability from the current observation). A request for a sponge in a sponge-less room gets its "fetch sponge" plan vetoed by the value term and rerouted to an alternative. Your takeaway pattern — <em>LLM prior × learned grounding</em> — recurs everywhere downstream.</p>
    ...
    <div class="resources">
      ...
      <ul>
        ...
        <li><span class="rtag">Note</span>No lecture recording posted for this week on the course page — the guest spotlight is the video content.</li>
      </ul>
    </div>
...
import LatencyWidget from '../widgets/LatencyWidget.vue';
